    ...
    <div className="relative w-full">
      <div className="grid place-items-center min-h-[92vh] px-8">
        <div className="container mx-auto grid place-items-center h-max text-center">
          ...
          <Button color="gray" onClick={() => window.open('https://drive.google.com/file/d/1pov2u1hWYTVkvIjnYNbgfHr6cL_uw0-_/view?usp=sharing', '_blank')}  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>Resume</Button>
          <Button color="gray" onClick={() => window.location.href = `mailto:${EMAIL}`}  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>Message me</Button>
          </div>
