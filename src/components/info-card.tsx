...
export function InfoCard({ icon: Icon, title, date, children, button}: InfoCardProps) {
  return (
    <Card  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
      ...
      <CardBody className="grid justify-start !px-3.5 pt-2"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        ...
        <Typography className="font-normal text-gray-500" style={{ textAlign: 'right' }}  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
            {button}    
        </Typography>
      </CardBody>
    </Card>
